...
plt.savefig('../output/FigS2_Training2d.png')
...
plt.savefig('../output/FigS2_Data2dGPC.png')
...
plt.tight_layout()
plt.savefig('../output/FigS2_f1score_prob.svg')
...
plt.tight_layout()
plt.savefig('../output/FigS2_pp7Nucfluor.svg')
...
for fluor, fluor_name in fluor_metrics:
    ...
    plt.tight_layout()
    plt.savefig('../output/FigS2_pp7{}vNucfluor.svg'.format(fluor))
...
for fluor, fluor_name in fluor_metrics:
    ...
    plt.tight_layout()
    plt.savefig('../output/FigS2_pp7{}.svg'.format(fluor))
