...
plt.tight_layout()
plt.savefig('../output/Fig5_growthrates_FUS.svg')
...
plt.tight_layout()
plt.savefig('../output/Fig5_growthvbrate.svg')
...
plt.savefig('../output/Fig5_selfrecruit.svg')
...
plt.savefig('../output/Fig5_selfrecruit_TS.svg')
