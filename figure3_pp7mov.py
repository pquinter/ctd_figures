...
plt.tight_layout()
plt.savefig('../output/example_trace.svg')
...
plt.savefig('../output/Fig3_pp7traces_afmhot.png')
...
plt.tight_layout()
plt.savefig('../output/Fig3_pp7movfluor.svg')
...
plt.tight_layout()
plt.savefig('../output/Fig3_pp7interburst.svg')
...
plt.tight_layout()
plt.savefig('../output/Fig3_pp7fracactive.svg')
...
plt.tight_layout()
plt.savefig('../output/Fig3_pp7snapshotfluor.svg')

###############################################################################
# Sample image of PP7 cell for diagram
###############################################################################
mov = io.imread('/Users/porfirio/lab/yeastEP/ms2pp7/data/2019_galinducedt0/02132019_yQC21_150u10%int480_1.tif')
...
for frame_no, active in zip((frame_no_active, frame_no_inactive), ('active','inactive')):
    ...
    io.imsave('/Users/porfirio/Desktop/yQC21pp7movsample_{}.tif'.format(active), im)
...
plt.tight_layout()
plt.savefig('../output/Fig3_alignedBooltraces.svg')
