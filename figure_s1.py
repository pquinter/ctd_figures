...
rpb1aacount = pd.read_csv('/Users/porfirio/lab/yeastEP/figures_paper/data/rpb1_aacounts.csv')
...
plt.tight_layout()
plt.savefig('../output/FigS1_aaComp.svg')

################################################################################
# Distributions of aromaticity, net charge and GRAVY
################################################################################

rpb1props = pd.read_csv('/Users/porfirio/lab/yeastEP/figures_paper/data/rpb1_chem_props.csv')
for prop, name in zip(('arom','gravy','net_charge'),('Aromaticity',' Grand Average of Hydropathy','Net Charge')):
    ...
    plt.tight_layout()
    plt.savefig('../output/FigS1_LD{}.svg'.format(prop))
